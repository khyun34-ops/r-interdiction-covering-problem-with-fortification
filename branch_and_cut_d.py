...
for n , pairs in qr_set.items():
    adj_data=np.load("data/Final_adj{}_10.npz".format(n))['arr_0']
    demand_Data=np.load("data/Final_demand{}_10.npz".format(n))['arr_0']
    result=open("result/D_BCresult{}.txt".format(n),"w")
    for q,r in pairs:
        ...
        master=cplex.Cplex()
        master.parameters.timelimit.set(1800)
        # master.parameters.mip.tolerances.mipgap.set(0.001)
        ...
        result.write("{}     {}     {}      {}    {}     {}\n".format(q,r, master.solution.get_objective_value(), sum_w, max_C,end_time-start_time))
